...
(function () {
  ...
  var occluder = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({ color: 0x07070a, transparent: true, opacity: 0.92 })
  );
  globe.add(occluder);
  ...
  var rim = new THREE.Mesh(
    ...
    new THREE.ShaderMaterial({
      ...
      fragmentShader:
        ...
        "void main(){ gl_FragColor = vec4(c, 1.0) * vI * 0.55; }"
    })
  );
  globe.add(rim);
  ...
  fetch("https://cdn.jsdelivr.net/npm/world-atlas@2/land-110m.json")
    ...
    .then(function (topo) {
      ...
      globe.add(new THREE.Points(geo, new THREE.PointsMaterial({
        color: 0x8f96a3, size: 0.0085, transparent: true, opacity: 0.85, sizeAttenuation: true
      })));
    })
